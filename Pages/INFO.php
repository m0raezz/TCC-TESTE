...
<head>
    ...
    <!-- Bootstrap e CSS -->
    <link rel="stylesheet" href="./Pages_CSS/info.css">
    <link rel="stylesheet" href="../style.css">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-YvpcrYf0tY3lHB60NNkmXc5s9fDVZLESaAA55NDzOxhy9GkcIdslK1eN7N6jIeHz" crossorigin="anonymous"></script>

    <style>
        /* Estilizando a tabela fixa na esquerda */
        .tabela-lateral {
            position: fixed;
            top: 80px; /* Para ajustar abaixo do navbar */
            left: 10px;
            width: 200px;
            height: 80%;
            overflow-y: auto; /* Permitir rolagem se a tabela for maior que a tela */
...
<body>
    ...
    <div class="container mt-5 container-custom">
        ...
        <section class="avaliacoes-header">
            <span>Avaliações Pendentes - Curso</span>
